...
import {setCookies} from "../helper/util/helpers";
import {BASE_CONFIG} from "../helper/util/config";
...
BeforeAll(async function () {
    setDefaultTimeout(BASE_CONFIG.TIMEOUT);
